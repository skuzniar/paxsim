#ifndef FIX_Modules_Factory_FIX42_OrderCancelOnDisconnect_dot_h
#define FIX_Modules_Factory_FIX42_OrderCancelOnDisconnect_dot_h
...
public:
    ...
    OMessage cancel(const Order& o)
    {
        ...
        omsg.push_back_string(tag::Text, "Canceled on disconnect");
