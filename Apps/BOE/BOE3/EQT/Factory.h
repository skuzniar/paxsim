#ifndef BOE_BOE3_EQT_Factory_dot_h
#define BOE_BOE3_EQT_Factory_dot_h

#include "PaxSim/Core/Streamlog.h"

#include "BOE/BOE3/EQT/ServerHeartbeat.h"
#include "BOE/BOE3/EQT/ClientHeartbeat.h"

#include "BOE/BOE3/EQT/LoginRequest.h"
#include "BOE/BOE3/EQT/LoginResponse.h"
#include "BOE/BOE3/EQT/LogoutRequest.h"

#include "BOE/BOE3/EQT/NewOrderUSEquitiesV1.h"
#include "BOE/BOE3/EQT/ModifyOrderUSEquitiesV1.h"
#include "BOE/BOE3/EQT/CancelOrderUSEquitiesV1.h"

#include "BOE/BOE3/EQT/OrderAcknowledgementUSEquitiesV1.h"
#include "BOE/BOE3/EQT/OrderRejectedUSEquitiesV1.h"

#include "BOE/BOE3/EQT/OrderModifiedUSEquitiesV1.h"

#include "BOE/BOE3/EQT/OrderCancelledUSEquitiesV1.h"
#include "BOE/BOE3/EQT/CancelRejectedUSEquitiesV1.h"
...
class Factory
{
    ...
    //-----------------------------------------------------------------------------------------------------------------
public:
    using MessageHeader = boe3::eqt::Header;

    using LoginRequest  = boe3::eqt::LoginRequest;
    using LoginResponse = boe3::eqt::LoginResponse;
    using LogoutRequest = boe3::eqt::LogoutRequest;

    using NewOrder    = boe3::eqt::NewOrderUSEquitiesV1;
    using ModifyOrder = boe3::eqt::ModifyOrderUSEquitiesV1;
    using CancelOrder = boe3::eqt::CancelOrderUSEquitiesV1;
    ...
    // Message arrival.
    //-----------------------------------------------------------------------------------------------------------------
    static std::pair<bool, const Header&> message(const char* buff, std::size_t size)
    {
        const auto* header = reinterpret_cast<const Header*>(buff);
    ...
    {
        LoginResponse response(LoginResponseStatus::Accepted);
        return response;
    }
    ...
    auto report(const Fill& fill, const Order& order)
    {
        ...
        omsg.liquidityAttributes =
            LiquidityAttributes(LiquidityIndicator::Auction, LiquidityInternalized::Internalized, LiquidityTopOfBook::TopOfBook,
    LiquiditySelfTrade::SelfTrade); omsg.lastMarket = Market::DHEL;
