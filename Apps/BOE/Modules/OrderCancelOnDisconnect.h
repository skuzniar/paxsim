#ifndef BOE_Modules_OrderCancelOnDisconnect_dot_h
#define BOE_Modules_OrderCancelOnDisconnect_dot_h

#include "PaxSim/Core/Streamlog.h"

#include "BOE/Context/Session.h"
#include "BOE/Context/OrderBook.h"
#include "BOE/Context/FillsBook.h"
