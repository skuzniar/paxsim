#ifndef Factory_ExecutionBook_FIX42Cancellations_dot_h
#define Factory_ExecutionBook_FIX42Cancellations_dot_h
...
//---------------------------------------------------------------------------------------------------------------------
class FIX42Cancellations
{
public:
    template<typename Context>
    explicit FIX42Cancellations(Context& context)
      : m_session(context)
