...
#include "Echo-4/Source.h"
#include "Echo-4/Format.h"
#include "Echo-4/Target.h"
...
main(int argc, char* argv[])
{
    ...
    try {
        ...
        using Handler = Core::Pipeline<Text::Source, Core::Flareout<Text::Format, Text::Upcase>, Text::Target>;
