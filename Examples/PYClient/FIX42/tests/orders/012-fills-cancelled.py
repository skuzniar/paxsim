...
def run(session):
    ...
    # Two partial fills
    session.expect_all([
        ({35:'8'}, {39:'1', 150:'1', 11:nor.getField(11), 31:'1.230', 32:'101', 151:'6003'}),
        ({35:'8'}, {39:'1', 150:'1', 11:nor.getField(11), 31:'2.340', 32:'202', 151:'5801'})
        ])

    # Two trade cancells
    session.expect_all([
            ({35:'8'}, {39:'1', 150:'5', 11:nor.getField(11), 31:'0.000', 32:'0'}),
            ({35:'8'}, {39:'1', 150:'5', 11:nor.getField(11), 31:'0.000', 32:'0'}),
            ])
